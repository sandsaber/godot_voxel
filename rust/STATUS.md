...
| 4 — Terrain + threading (storage/streaming/meshing/paging/graph) | 🟡 IN PROGRESS | 646 unit + 10 integration |
| 5 — Godot binding + editor | ⏳ not started | — |

**Total:** 646 unit tests + 10 integration + 1 doc-test, clippy clean.
...
```bash
cd rust
cargo test -p voxel-core       # 646 unit + 10 integration + 1 doc-test
