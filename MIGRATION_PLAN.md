...
| 4.6 | `engine::voxel_data` | `engine/voxel_data.{h,cpp}` | VoxelDataMap, streams, generators, LOD | In progress: streaming voxel data grid, LOD updates, destination-masked storage ops, modification consumption, generator-backed pre-generation |
