...
| 4.6 | `storage::voxel_data` | `storage/voxel_data.{h,cpp}` | VoxelDataMap, streams, generators, LOD | In progress: generator-backed pre-generation, save/unload modification consumption, LOD updates/downscaling, streaming task integration |
